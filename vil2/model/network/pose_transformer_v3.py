...
class PoseTransformerV3(nn.Module):
    ...
    def encode_cond(
        ...
        return all_target_points, all_fixed_points

    def predict_coarse(self, all_target_points: list[list[torch.Tensor]], all_fixed_points: list[list[torch.Tensor]]):
        fixed_coord, fixed_feat, fixed_offset = all_fixed_points[0]  # Use the last layer
        ...
        target_feat = self.coarse_pcd_decoder(
            ...
            context_feat=fixed_feat,
            context_coord=fixed_coord,
        )
