...
class PoseTransformerV2(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        # Encode pcd features
        self.pcd_transformer = PointTransformerNetwork(
            grid_sizes,  # (2)
            depths,  # (3)
            dec_depths,  # (2)
            hidden_dims,  # (3)
    ...
    def encode_cond(
        ...
        center1, enc_pcd1 = self.pcd_transformer(coord1, pcd_feat1)
        center2, enc_pcd2 = self.pcd_transformer(coord2, pcd_feat2)
