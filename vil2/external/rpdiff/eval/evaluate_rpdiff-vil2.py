...
from vil2.external.rpdiff.share.globals import bad_shapenet_mug_ids_list, bad_shapenet_bowls_ids_list, bad_shapenet_bottles_ids_list
...
from vil2.external.rpdiff.utils.eval_gen_utils import constraint_obj_world, safeCollisionFilterPair, safeRemoveConstraint
...
def main(args: config_util.AttrDict) -> None:
    ...
    for iteration in range(exp_args.start_iteration, exp_args.num_iterations):
        ...
        if eval_dmorp:
            ...
            save_file_path = build_dataset_rdiff_eval(cfg = cfg, parent_pcd_f = parent_pcd_original, child_pcd_f = child_pcd_original, parent_pose_s = multi_mesh_dict["parent_pose"][0], index=0)
            ...
            relative_trans_pred = infer_relation_policy(
                mc_vis=mc_vis, 
                parent_pcd=parent_pcd, child_pcd=child_pcd_guess, 
