...
from vil2.external.rpdiff.utils import util, config_util, path_util
from vil2.external.rpdiff.utils.torch_util import dict_to_gpu
from vil2.external.rpdiff.utils.mesh_util import three_util
# from vil2.external.rpdiff.training.policy_local import dataio_chunked as dataio, losses
from vil2.external.rpdiff.training import dataio_full_chunked as dataio, losses
...
# from vil2.external.rpdiff.training.policy_full.train_util import adjust_learning_rate
from vil2.external.rpdiff.model.coarse_affordance import CoarseAffordanceVoxelRot
from vil2.external.rpdiff.training.train_loops import (
    train_iter_coarse_aff, train_iter_refine_pose, train_iter_success)
from vil2.external.rpdiff.training.pred_util import (
