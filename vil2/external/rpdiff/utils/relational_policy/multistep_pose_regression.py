...
from vil2.external.rpdiff.utils import util, path_util
from vil2.external.rpdiff.utils.mesh_util import three_util
from vil2.external.rpdiff.utils.torch_util import angle_axis_to_rotation_matrix, transform_pcd_torch
from vil2.external.rpdiff.utils.torch3d_util import matrix_to_quaternion, quaternion_to_matrix, matrix_to_axis_angle, axis_angle_to_matrix
from vil2.external.rpdiff.utils.torch_scatter_utils import fps_downsample

from vil2.external.rpdiff.training.train_util import crop_pcd_batch
from vil2.external.rpdiff.utils import batch_pcd_util
...
def multistep_regression_scene_combine_sc(
    ...
    if util.exists_and_true(kwargs, 'compute_coverage_scores'):
        ...
        from vil2.external.rpdiff.utils.relational_policy.filter_multimodal_placement import remove_redundant_tf
    ...
    if no_sc_score:
        ...
        if with_coll:
            ...
            from vil2.external.rpdiff.utils.relational_policy.filter_multimodal_placement import manual_place_success, manual_place_success_gt
    ...
    if util.exists_and_true(kwargs, 'compute_coverage_scores'):
        ...
        from vil2.external.rpdiff.utils.relational_policy.filter_multimodal_placement import compute_coverage
